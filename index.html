				...
				<acide class="right-acide">
					...
					<section id="step3" style="display: none">
						<form action="script/centraladmin.php?action=registration2" method="post">
							...
							<div class="terms-text">
								Do you have a bonus code? Click <span class="show-bonus-code" onclick="$('input[name=\'bonus_code\']').css('opacity',1)">here</span>.
							</div>
							<br />
							<div class="reg-input">
								<input type="password" name="bonus_code"  placeholder="Bonus Code" class="reg-input-text" style="opacity:0"/>
							</div>
							<div class="img-loader" style="display:none"></div>
							<input type="submit" value="Register" />
						</form>
